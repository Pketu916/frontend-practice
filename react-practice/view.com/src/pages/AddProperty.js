...
const AddProperty = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If imageLg is not provided, use the same as image
      if (!propertyData.imageLg) {
        propertyData.imageLg = propertyData.image
      }
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                className="flex-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"
              />
              <div className="relative">
                ...
                />
                <button type="button" className="px-4 py-3 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">
                  Browse...
                </button>
              </div>
            </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={handleChange}
                placeholder="Enter large image URL or select file"
                className="flex-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"
              />
              <div className="relative">
                <input
